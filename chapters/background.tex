...
An important notion in abstract interpretation is that of complete abstraction. A correct abstraction of a function is said to be complete if it doesn't lose precision with respect to the concrete semantics.
