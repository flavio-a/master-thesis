...
\end{figure}
\begin{proof}
	For the sake of simplicity, let us assume that the Galois connections $\ugc{\pow(C_x)}{\alpha_x}{\gamma_x}{A_x}$ for each variable $x$ are actually Galois insertions, and let us use the usual identification of $A_x$ and $\gamma(A_x) \subseteq \pow(C_x)$.
